...
GRANT EXECUTE ON PROCEDURE hospital_management.refresh_patient_secure_view TO 'group5_admin_app_user'@'localhost';
GRANT EXECUTE ON PROCEDURE hospital_management.refresh_staff_secure_view TO 'group5_admin_app_user'@'localhost';
